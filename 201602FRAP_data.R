# 20160222 all ArkN FRAP data analysis with R

# read file list
constructs = c('N725', 'N725sim', 'N725dHis', 'N865', 'N865sim', 'N865dHis', 'N865simhis')
...
all_files = list(
  ...
  N725dHis = Sys.glob(paste0(base_path, '20160218FRAP_EGFP-ArkN_delHis/*N725dHis*.txt')),
  ...
  N865dHis = Sys.glob(paste0(base_path, '20160218FRAP_EGFP-ArkN_delHis/*N865dHis*.txt')),
